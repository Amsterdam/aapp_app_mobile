...
export const ParkingSessionDetails = ({
  ...
  const isActiveOrPlannedSession =
    parkingSession.status === ParkingSessionStatus.active ||
    ...
    <Box>
      <Column gutter="lg">
        <ParkingSessionDetailsRow
          iconName="car"
          testID="ParkingSessionDetailsLicensePlate"
          title="Kenteken">
        ...
        {!parkingSession.parking_machine && (
          <ParkingSessionDetailsRow
            iconName="map-marker"
            testID="ParkingSessionDetailsPermitZone"
        ...
        <ParkingSessionDetailsRow
          iconName="clock"
          testID="ParkingSessionDetailsParkingTime"
          title={
        ...
        {!!shouldShowCosts && (
          <ParkingSessionDetailsRow
            iconName="euro-coins"
            testID="ParkingSessionDetailsParkingCost"
            title="Kosten">
            <Phrase>
              {formatNumber(
                parkingSession.parking_cost.value,
