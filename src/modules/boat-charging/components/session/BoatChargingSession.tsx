      ...
      <Column gutter="md">
        <Column gutter="lg">
          ...
          {sessionLengthStatus === SessionLengthStatus.expiryWarning && (
            <Notice
              text={`Uw boot mag maximaal ${settings.session_expiry_hours} uur laden. Daarna betaalt u ${formatNumber(settings.standardFine, 'EUR')} per uur. Ook als u maar een deel van een uur gebruikt, betaalt u voor het hele uur.`}
              variant="information"
            />
          )}
          {sessionLengthStatus === SessionLengthStatus.expiry && (
            <Notice
              text={`Uw boot ligt langer dan ${settings.session_expiry_hours} uur bij het laadpunt. U betaalt nu ${formatNumber(settings.standardFine, 'EUR')} per uur. Ook als u maar een deel van een uur gebruikt, betaalt u voor het hele uur.`}
              variant="negative"
            />
          )}
