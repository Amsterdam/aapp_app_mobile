...
//      context = this,
  ...
  override fun unlock(bluetoothContainerDevice: ReadableMap, cardNumber: String) {
    bluetoothConnectionManager.unlock(parseBluetoothContainerDevice(bluetoothContainerDevice), cardNumber)
  }
  ...
  private fun parseBluetoothContainerDevice(bluetoothContainerDevice: ReadableMap): BluetoothContainerDevice {
    return BluetoothContainerDevice(
      bluetoothConnectionManager = bluetoothConnectionManager,
      name = bluetoothContainerDevice.getString("name") ?: "",
      address = bluetoothContainerDevice.getString("address") ?: "",
      rssi = bluetoothContainerDevice.getInt("rssi")
    )
  }
